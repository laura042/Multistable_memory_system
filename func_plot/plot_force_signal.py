...
force = np.loadtxt(os.path.join(args.path_for_loading, './{}/force_{}_{}_{}.npy'.format(args.dirname_for_loading, args.transition, 'c_{}_{}'.format(int(args.c), int(str(args.c).split('.')[1])), args.num_fig)))
