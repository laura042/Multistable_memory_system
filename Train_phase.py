...
parser.add_argument("--eval_n_episodes", type=int, default=10, help="")
...
parser.add_argument("--dirname_for_loading", type=str, default=None, help="dirname for loading the model")
...
parser.add_argument("--success_threshold", type=float, default=0.9, help="success rate threshold for stopping learning")
