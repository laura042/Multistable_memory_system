...
parser.add_argument("--path_to_save", type=str, default='/home/laura/Laura/Systmemoire_work/Multistable_Memory_System/results', help="path for pos/vel/force results")
parser.add_argument("--dirname_to_save", type=str, default='TEST_art', help="dirname to save pos/vel/force results")
parser.add_argument("--path_for_loading", type=str, default='/home/laura/Laura/Systmemoire_work/Multistable_Memory_System/results', help="path for loading models")
parser.add_argument("--dirname_for_loading", type=str, default='c_2_0', help="dirname for loading models")
